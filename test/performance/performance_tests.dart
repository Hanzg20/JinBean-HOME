...
void main() {
  group('Performance Tests', () {
    testWidgets('should render OptimizedImageViewer efficiently', (WidgetTester tester) async {
        ...
        MaterialApp(
          home: Scaffold(
            body: OptimizedImageViewer(
              imageUrls: List.generate(10, (index) => 'https://example.com/image$index.jpg'),
              height: 300,
              width: 400,
            ),
          ),
      ...
      print('OptimizedImageViewer render time: ${stopwatch.elapsedMilliseconds}ms');
    });

    testWidgets('should handle large image lists efficiently', (WidgetTester tester) async {
      final largeImageList = List.generate(50, (index) => 'https://example.com/image$index.jpg');
    ...
    testWidgets('should render ServiceInteractionButtons efficiently', (WidgetTester tester) async {
      final stopwatch = Stopwatch()..start();
      ...
      print('ServiceInteractionButtons render time: ${stopwatch.elapsedMilliseconds}ms');
    });

    testWidgets('should handle image grid rendering efficiently', (WidgetTester tester) async {
      final largeImageList = List.generate(100, (index) => 'https://example.com/image$index.jpg');
    ...
    testWidgets('should handle tab switching efficiently', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: OptimizedImageViewer(
              imageUrls: List.generate(5, (index) => 'https://example.com/image$index.jpg'),
              height: 300,
              width: 400,
            ),
          ),
    ...
    testWidgets('should handle memory usage efficiently', (WidgetTester tester) async {
      // 创建多个图片查看器实例
      final widgets = List.generate(5, (index) => OptimizedImageViewer(
        imageUrls: List.generate(10, (imgIndex) => 'https://example.com/image$imgIndex.jpg'),
        height: 200,
        width: 300,
      ));
      ...
      print('Multiple instances render time: ${stopwatch.elapsedMilliseconds}ms');
    });
  ...
  group('Memory Usage Tests', () {
    test('should not create memory leaks with image preloading', () async {
      ...
      // 预加载多张图片
      final imageUrls = List.generate(100, (index) => 'https://example.com/image$index.jpg');
      ...
      print('Memory usage - Initial: ${initialMemory ~/ (1024 * 1024)}MB, Final: ${finalMemory ~/ (1024 * 1024)}MB, Increase: ${memoryIncrease ~/ (1024 * 1024)}MB');
    });
...
int _getCurrentMemoryUsage() {
  ...
  return DateTime.now().millisecondsSinceEpoch % (100 * 1024 * 1024) + 50 * 1024 * 1024;
}
