...
void main() {
  group('ProviderTheme Tests', () {
    test('ProviderTheme light theme should be different from base theme', () {
      ...
      expect(providerTheme.colorScheme.primary,
          isNot(baseTheme.colorScheme.primary));
    ...
    test('ProviderTheme dark theme should be different from base dark theme',
      ...
      expect(providerDarkTheme.colorScheme.primary,
          isNot(baseDarkTheme.colorScheme.primary));
    });
