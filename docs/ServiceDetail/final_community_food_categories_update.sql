-- =====================================================
-- JinBean Platform - 美食天地分类最终更新脚本
-- 使用"社区美食"替代"家庭厨房"，符合加拿大合规要求
-- =====================================================
...
BEGIN
    ...
    -- 更新 1010100: 居家美食 -> 社区美食 (保持原有code: HOME_COOKED)
    UPDATE ref_codes 
    SET 
    ...
    -- 更新 1010200: 定制美食 -> 餐厅预订 (保持原有code: CUSTOM_CATERING)
    UPDATE ref_codes 
    SET 
    ...
    -- 更新 1010300: 世界美食 -> 团体餐饮 (保持原有code: WORLD_CUISINE)
    UPDATE ref_codes 
    SET 
    ...
    -- 更新 1010400: 速食代购 -> 食材采购 (保持原有code: QUICK_EATS)
    UPDATE ref_codes 
    SET 
    ...
    -- 更新 1010500: 其它 -> 其它 (保持原有code: FOOD_COURT_OTHER)
    UPDATE ref_codes 
    SET 
    ...
    RAISE NOTICE '更新了5个分类：社区美食、餐厅预订、团体餐饮、食材采购、其它';
    RAISE NOTICE '符合加拿大合规要求，避免"家庭厨房"的合规风险';
END $$;
...
SELECT 
    ...
    rc2.extra_data->>'description_zh' as "中文描述"
FROM ref_codes rc1
