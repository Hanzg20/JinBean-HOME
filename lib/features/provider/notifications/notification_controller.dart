...
class NotificationController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    AppLogger.info('[NotificationController] Controller initialized',
        tag: 'Notification');
    loadNotifications();
    loadUnreadCount();
  }
  ...
  Future<void> loadNotifications() async {
    try {
      ...
      AppLogger.error(
          '[NotificationController] Error loading notifications: $e',
          tag: 'Notification');
      Get.snackbar(
        'Error',
  ...
  Future<void> loadUnreadCount() async {
    try {
      ...
      AppLogger.error('[NotificationController] Error loading unread count: $e',
          tag: 'Notification');
    }
  }
  ...
  Future<void> markAsRead(String notificationId) async {
    try {
      ...
      if (success) {
        ...
        AppLogger.info(
            '[NotificationController] Notification $notificationId marked as read',
            tag: 'Notification');
      }
    } catch (e) {
      AppLogger.error(
          '[NotificationController] Error marking notification as read: $e',
          tag: 'Notification');
    }
  }
  ...
  Future<void> markAllAsRead() async {
    try {
      ...
      if (success) {
        ...
        AppLogger.info(
            '[NotificationController] All notifications marked as read',
            tag: 'Notification');
      }
    } catch (e) {
      AppLogger.error(
  ...
  Future<void> deleteNotification(String notificationId) async {
    try {
      ...
      if (success) {
        ...
        AppLogger.info(
            '[NotificationController] Notification $notificationId deleted',
            tag: 'Notification');
      }
    } catch (e) {
      AppLogger.error(
          '[NotificationController] Error deleting notification: $e',
          tag: 'Notification');
      Get.snackbar(
        'Error',
