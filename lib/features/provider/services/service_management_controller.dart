...
class ServiceManagementController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    AppLogger.info('[ServiceManagementController] Controller initialized',
  ...
  Future<void> loadServices({bool refresh = false}) async {
    try {
      ...
      if (selectedStatus.value != null) {
        servicesList =
            await _serviceService.getServicesByStatus(selectedStatus.value!);
      } else {
      ...
      AppLogger.info(
          '[ServiceManagementController] Loaded ${services.length} services',
          tag: 'ServiceManagement');
    } catch (e) {
      AppLogger.error(
          '[ServiceManagementController] Error loading services: $e',
          tag: 'ServiceManagement');
      Get.snackbar(
        'Error',
  ...
  Future<void> loadServiceStats() async {
    try {
      ...
      AppLogger.error(
          '[ServiceManagementController] Error loading service stats: $e',
          tag: 'ServiceManagement');
    }
  }
  ...
  Future<bool> createService(Service service) async {
    try {
      ...
      if (success) {
        ...
        AppLogger.info(
            '[ServiceManagementController] Service created successfully',
            tag: 'ServiceManagement');
      } else {
        Get.snackbar(
          'Error',
      ...
      AppLogger.error(
          '[ServiceManagementController] Error creating service: $e',
          tag: 'ServiceManagement');
      Get.snackbar(
        'Error',
        'Failed to create service. Please try again.',
  ...
  Future<bool> updateService(Service service) async {
    try {
      ...
      if (success) {
        ...
        AppLogger.info(
            '[ServiceManagementController] Service ${service.id} updated successfully',
            tag: 'ServiceManagement');
      } else {
        Get.snackbar(
          'Error',
      ...
      AppLogger.error(
          '[ServiceManagementController] Error updating service: $e',
          tag: 'ServiceManagement');
      Get.snackbar(
        'Error',
        'Failed to update service. Please try again.',
  ...
  Future<bool> deleteService(String serviceId) async {
    try {
      ...
      if (success) {
        ...
        AppLogger.info(
            '[ServiceManagementController] Service $serviceId deleted successfully',
            tag: 'ServiceManagement');
      } else {
        Get.snackbar(
          'Error',
      ...
      AppLogger.error(
          '[ServiceManagementController] Error deleting service: $e',
          tag: 'ServiceManagement');
      Get.snackbar(
        'Error',
        'Failed to delete service. Please try again.',
  ...
  Future<bool> updateServiceStatus(
    ...
    try {
      final success =
          await _serviceService.updateServiceStatus(serviceId, status);
      ...
      if (success) {
        ...
        AppLogger.info(
            '[ServiceManagementController] Service $serviceId status updated to ${status.name}',
            tag: 'ServiceManagement');
      }
      ...
      AppLogger.error(
          '[ServiceManagementController] Error updating service status: $e',
          tag: 'ServiceManagement');
      return false;
    }
  }
  ...
  Future<Service?> getServiceDetails(String serviceId) async {
    try {
      ...
      AppLogger.error(
          '[ServiceManagementController] Error getting service details: $e',
          tag: 'ServiceManagement');
      return null;
    }
  }
