...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            if (controller.service?.serviceDetailsJson != null)
              _buildDetailRow('Description', controller.service!.serviceDetailsJson!['description'] ?? 'N/A', theme),
            if (controller.serviceDetail?.duration != null)
              _buildDetailRow('Duration', _formatDuration(controller.serviceDetail!.duration!), theme),
          ],
        ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              'Coverage: 5km radius from service location',
              style: theme.textTheme.bodyMedium,
            ),
            const SizedBox(height: 4),
            Text(
  ...
  void _toggleMapFullscreen() {
    Get.snackbar(
      'Map Fullscreen',
      'Fullscreen map feature coming soon',
      snackPosition: SnackPosition.BOTTOM,
    );
  }
  ...
  void _showQuickBookingDialog(ServiceDetailController controller) {
    Get.dialog(
      AlertDialog(
        ...
        content: const Text('Quick booking feature coming soon'),
        actions: [
          TextButton(
            onPressed: () => Get.back(),
            child: const Text('OK'),
  ...
  Widget _buildQuoteStatus(ServiceDetailController controller, ThemeData theme) {
    if (controller.quoteRequestStatus.value.isEmpty) {
      return const SizedBox.shrink();
    }
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                'Quote Status: ${controller.quoteRequestStatus.value}',
                style: theme.textTheme.bodyMedium,
              ),
            ),
          ],
