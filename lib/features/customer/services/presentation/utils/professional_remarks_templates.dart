...
class ProfessionalRemarksTemplates {
  ...
  /// 获取服务特色模板
  static List<FeatureItem> getServiceFeatures(
      String serviceType, Map<String, dynamic>? providerData) {
    switch (serviceType) {
  ...
  /// 获取质量保证模板
  static String getQualityAssurance(
      String serviceType, Map<String, dynamic>? providerData) {
    switch (serviceType) {
      case CLEANING_SERVICE:
  ...
  /// 获取专业资质模板
  static String getProfessionalQualification(
      String serviceType, Map<String, dynamic>? providerData) {
    switch (serviceType) {
      case CLEANING_SERVICE:
  ...
  /// 获取服务经验模板
  static String getServiceExperience(
      String serviceType, Map<String, dynamic>? providerData) {
  ...
  /// 获取服务特色模板
  static String getServiceHighlights(
      String serviceType, Map<String, dynamic>? providerData) {
    switch (serviceType) {
      case CLEANING_SERVICE:
  ...
  // 清洁服务特色
  static List<FeatureItem> _getCleaningServiceFeatures(
  ...
  // 维修服务特色
  static List<FeatureItem> _getMaintenanceServiceFeatures(
      Map<String, dynamic>? providerData) {
    return [
      FeatureItem(
        Icons.build,
  ...
  // 美容服务特色
  static List<FeatureItem> _getBeautyServiceFeatures(
      Map<String, dynamic>? providerData) {
    return [
      FeatureItem(
        Icons.face,
  ...
  // 教育服务特色
  static List<FeatureItem> _getEducationServiceFeatures(
      Map<String, dynamic>? providerData) {
    return [
      FeatureItem(
        Icons.school,
  ...
  // 运输服务特色
  static List<FeatureItem> _getTransportationServiceFeatures(
      Map<String, dynamic>? providerData) {
    return [
      FeatureItem(
        Icons.drive_eta,
  ...
  // 餐饮服务特色
  static List<FeatureItem> _getFoodServiceFeatures(
      Map<String, dynamic>? providerData) {
    return [
      FeatureItem(
        Icons.restaurant,
  ...
  // 健康服务特色
  static List<FeatureItem> _getHealthServiceFeatures(
      Map<String, dynamic>? providerData) {
    return [
      FeatureItem(
  ...
  // 技术服务特色
  static List<FeatureItem> _getTechnologyServiceFeatures(
      Map<String, dynamic>? providerData) {
    return [
      FeatureItem(
        Icons.computer,
  ...
  // 通用服务特色
  static List<FeatureItem> _getGeneralServiceFeatures(
      Map<String, dynamic>? providerData) {
    return [
      FeatureItem(
        Icons.verified_user,
  ...
  // 质量保证模板
  static String _getCleaningQualityAssurance(
      Map<String, dynamic>? providerData) {
  ...
  static String _getMaintenanceQualityAssurance(
      Map<String, dynamic>? providerData) {
  ...
  static String _getEducationQualityAssurance(
      Map<String, dynamic>? providerData) {
  ...
  static String _getTransportationQualityAssurance(
      Map<String, dynamic>? providerData) {
  ...
  static String _getTechnologyQualityAssurance(
      Map<String, dynamic>? providerData) {
  ...
  static String _getGeneralQualityAssurance(
      Map<String, dynamic>? providerData) {
