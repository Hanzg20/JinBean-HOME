  ...
  void initState() {
    ...
    _tabController.addListener(() {
      if (!_tabController.indexIsChanging) {
        AppLogger.info(
            'CommunityPage tab changed to index: ${_tabController.index}',
            tag: 'CommunityPage');
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      AppLogger.info(
          'CommunityPage post frame callback, selectedPostType: ${controller.selectedPostType.value}',
          tag: 'CommunityPage');
      if (controller.selectedPostType.value == CommunityPostType.event) {
        _tabController.index = 0;
      } else if (controller.selectedPostType.value ==
          CommunityPostType.subsidy) {
