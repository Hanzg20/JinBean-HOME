  ...
  static ThemeData get lightTheme {
    ...
    return baseTheme.copyWith(
      ...
      colorScheme: baseTheme.colorScheme.copyWith(
        ...
        surfaceContainerHighest: const Color(0xFFE8EAED), // 更专业的变体背景
      ),
      ...
      cardTheme: baseTheme.cardTheme.copyWith(
        ...
        margin:
            const EdgeInsets.symmetric(horizontal: 16, vertical: 8), // 更宽松的边距
      ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          padding: const EdgeInsets.symmetric(
              horizontal: 32, vertical: 16), // 更宽松的内边距
      ...
      inputDecorationTheme: baseTheme.inputDecorationTheme.copyWith(
        ...
        contentPadding:
            const EdgeInsets.symmetric(horizontal: 20, vertical: 16), // 更宽松的内边距
  ...
  static ThemeData get darkTheme {
    ...
    return baseTheme.copyWith(
      ...
      colorScheme: baseTheme.colorScheme.copyWith(
        ...
        surfaceContainerHighest: const Color(0xFF1E1E1E), // 标准的变体背景
      ),
