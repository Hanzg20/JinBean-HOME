...
class JinBeanSpacing {
  ...
  // 内边距
  static const EdgeInsets pagePaddingInsets =
      EdgeInsets.all(JinBeanSpacing.pagePadding);
  static const EdgeInsets cardPaddingInsets =
      EdgeInsets.all(JinBeanSpacing.cardPadding);
  static const EdgeInsets buttonPaddingInsets =
      EdgeInsets.all(JinBeanSpacing.buttonPadding);
  static const EdgeInsets inputPaddingInsets =
      EdgeInsets.all(JinBeanSpacing.inputPadding);
  ...
  static const EdgeInsets verticalPadding =
      EdgeInsets.symmetric(vertical: pagePadding);
  static const EdgeInsets verticalCardPadding =
