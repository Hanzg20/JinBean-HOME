...
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', (SELECT id FROM public.provider_profiles LIMIT 1), '{"en": "Standard Home Cleaning", "zh": "标准居家清洁"}', '{"en": "Comprehensive cleaning for homes, including living rooms, bedrooms, and bathrooms.", "zh": "全面家庭清洁，包括客厅、卧室和浴室的清洁。"}', 1020000, 1020100, 'active', 4.7, 95, 34.0522, -118.2437, 'on_site', now(), now());
...
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'negotiable', NULL, 'CAD', '价格取决于零件和人工。请致电估价。', 'hourly', ARRAY['https://example.com/plumb1.jpg'], ARRAY['紧急服务', '漏水修复', '疏通下水道'], '{"steps": ["诊断", "维修", "测试"]}');

-- 3. 生活帮忙 > 专业服务 > IT支持
INSERT INTO public.services (id, provider_id, title, description, category_level1_id, category_level2_id, status, average_rating, review_count, latitude, longitude, service_delivery_method, created_at, updated_at) VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13', (SELECT id FROM public.provider_profiles LIMIT 1), '{"en": "Remote Desktop Troubleshooting", "zh": "远程桌面故障排除"}', '{"en": "Get help with software issues, network problems, and virus removal remotely.", "zh": "远程协助解决软件问题、网络问题和病毒清除。"}', 1060000, 1060200, 'active', 4.5, 70, NULL, NULL, 'remote', now(), now());
INSERT INTO public.service_details (service_id, pricing_type, price, currency, duration_type, duration, tags, service_area_codes) VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13', 'fixed_price', 80.00, 'CAD', 'fixed', '1 hour', ARRAY['技术支持', '远程服务', '软件帮助'], ARRAY['CA']);

-- 4. 生活帮忙 > 健康支持 > 理疗服务
INSERT INTO public.services (id, provider_id, title, description, category_level1_id, category_level2_id, status, average_rating, review_count, latitude, longitude, service_delivery_method, created_at, updated_at) VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14', (SELECT id FROM public.provider_profiles OFFSET 1 LIMIT 1), '{"en": "Full Body Relaxation Massage", "zh": "全身放松按摩"}', '{"en": "Experience a calming full-body massage in the comfort of your home.", "zh": "在您舒适的家中享受全身放松按摩。"}', 1060000, 1060400, 'active', 4.9, 85, 34.0522, -118.2437, 'on_site', now(), now());
...
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14', 'fixed_price', 100.00, 'CAD', 'fixed', '60 minutes', ARRAY['https://example.com/massage1.jpg'], ARRAY['放松', '健康', '上门按摩'], '{"benefits": ["缓解压力", "肌肉放松"]}');

-- 5. 出行广场 > 日常接送 > 机场接送
INSERT INTO public.services (id, provider_id, title, description, category_level1_id, category_level2_id, status, average_rating, review_count, latitude, longitude, service_delivery_method, created_at, updated_at) VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a15', (SELECT id FROM public.provider_profiles LIMIT 1), '{"en": "Airport Transfer Service", "zh": "机场接送服务"}', '{"en": "Convenient airport transfer service, punctual and safe.", "zh": "便捷的机场接送服务，准时安全。"}', 1030000, 1030100, 'active', 4.8, 110, 34.0522, -118.2437, 'on_site', now(), now());
INSERT INTO public.service_details (service_id, pricing_type, price, currency, duration_type, duration, tags, service_area_codes) VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a15', 'fixed_price', 60.00, 'CAD', 'fixed', '90 minutes', ARRAY['机场', '接送', '交通'], ARRAY['YVR', 'LAX']);

-- 6. 美食天地 > 定制美食 > 聚会大餐
INSERT INTO public.services (id, provider_id, title, description, category_level1_id, category_level2_id, status, average_rating, review_count, latitude, longitude, service_delivery_method, created_at, updated_at) VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a16', (SELECT id FROM public.provider_profiles OFFSET 1 LIMIT 1), '{"en": "Private Custom Catering", "zh": "私人定制宴席"}', '{"en": "Customized theme banquets and party meals according to your needs.", "zh": "根据您的需求定制各种主题宴席和聚会餐点。"}', 1010000, 1010200, 'active', 4.9, 60, 34.0522, -118.2437, 'on_site', now(), now());
INSERT INTO public.service_details (service_id, pricing_type, price, currency, negotiation_details, duration_type, images_url, tags, service_details_json) VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a16', 'quote_based', NULL, 'CAD', '根据菜单和人数提供报价，欢迎咨询。', 'scope_based', ARRAY['https://example.com/catering1.jpg'], ARRAY['宴席', '聚会', '定制美食'], '{"cuisine_types": ["中餐", "西餐"], "min_guests": 10}');

-- 7. 学习课堂 > 学科辅导 > 英语/法语
INSERT INTO public.services (id, provider_id, title, description, category_level1_id, category_level2_id, status, average_rating, review_count, latitude, longitude, service_delivery_method, created_at, updated_at) VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a17', (SELECT id FROM public.provider_profiles LIMIT 1), '{"en": "English Speaking 1-on-1 Tutoring", "zh": "英语口语一对一辅导"}', '{"en": "Online English speaking 1-on-1 tutoring to help you improve fluency.", "zh": "在线英语口语一对一辅导，助您提升流利度。"}', 1050000, 1050100, 'active', 4.6, 50, NULL, NULL, 'online', now(), now());
...
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a17', 'hourly', 40.00, 'CAD', 'hours', '1 hour', ARRAY['https://example.com/tutoring1.jpg'], ARRAY['英语', '在线', '口语'], ARRAY['CA'], '{"level": ["初级", "中级", "高级"], "software": ["Zoom", "Skype"]}');

-- 8. 共享乐园 > 工具租赁 > 工具租赁
INSERT INTO public.services (id, provider_id, title, description, category_level1_id, category_level2_id, status, average_rating, review_count, latitude, longitude, service_delivery_method, created_at, updated_at) VALUES
('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a18', (SELECT id FROM public.provider_profiles OFFSET 1 LIMIT 1), '{"en": "Power Tool Rental", "zh": "电动工具租赁"}', '{"en": "Rent power tools for home improvement and DIY projects.", "zh": "为家庭装修和DIY项目租赁电动工具。"}', 1040000, 1040100, 'active', 4.7, 75, 49.2827, -123.1207, 'on_site', now(), now());
